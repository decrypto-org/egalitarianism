...
\begin{figure}[H]
    \caption{The egalitarianism of Bitcoin}
    \centering
    \includegraphics[width=0.75 \columnwidth,keepaspectratio]{figures/btc_dp_10K_12_months.pdf}
    \label{fig:btc_dp_10K_12_months}
\end{figure}

\begin{figure}[H]
    \caption{The egalitarianism of Ethereum}
    \centering
    \includegraphics[width=0.75 \columnwidth,keepaspectratio]{figures/eth_dp_10K_12_months.pdf}
    \label{fig:eth_dp_10K_12_months}
\end{figure}

\begin{figure}[H]
    \caption{The egalitarianism of Monero}
    \centering
    \includegraphics[width=0.75 \columnwidth,keepaspectratio]{figures/xmr_dp_10K_12_months.pdf}
    \label{fig:xmr_dp_10K_12_months}
\end{figure}

\begin{figure}[H]
    \caption{The egalitarianism of Decred}
    \centering
    \includegraphics[width=0.75 \columnwidth,keepaspectratio]{figures/xmr_dp_10K_12_months.pdf}
    \label{fig:xmr_dp_10K_12_months}
\end{figure}

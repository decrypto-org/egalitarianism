...
\cite{mathews1896partition} is solved to optimize the total cash flow.
...
\begin{figure}
  \placesubfigure{btc_dp_10K_12_months.pdf}{fig:btc_dp_10K_12_months}{The egalitarianism curve of Bitcoin.}{0.9}{0.5}
  \placesubfigure{eth_dp_10K_12_months.pdf}{fig:eth_dp_10K_12_months}{The egalitarianism curve of Ethereum.}{0.9}{0.5}
  \placesubfigure{ltc_dp_10K_12_months.pdf}{fig:ltc_dp_10K_12_months}{The egalitarianism curve of Litecoin.}{0.9}{0.5}
  \placesubfigure{xmr_dp_10K_12_months.pdf}{fig:xmr_dp_10K_12_months}{The egalitarianism curve of Monero.}{0.9}{0.5}
  \placesubfigure{dcr_dp_10K_12_months.pdf}{fig:dcr_dp_10K_12_months}{The egalitarianism curve of \emph{proof-of-work} Decred.}{0.9}{0.5}
...
\begin{figure}
  \placesubfigure{decred-stake.pdf}{fig:decred-stake}{The egalitarianism curve of \emph{proof-of-stake} Decred.}{0.9}{0.5}
  \placesubfigure{pure-pos.pdf}{fig:pure-pos-stake}{The egalitarianism curve of a \emph{pure} proof-of-stake system, \eg pure Ouroboros.}{0.9}{0.5}
...
system. In this case, the users pay a set transaction fee for the
...
the transation fees\footnote{As of January $2019$, according to
\url{https://cardanoexplorer.com/}, in the Cardano implementation of Ouroboros
these fees are in the order of $\$0.01$.} to participate in the staking process.

...
\begin{figure}
  \placesubfigure{btc_dp_10K_12_months.pdf}{fig:btc_dp_10K_12_months}{Egalitarianism of Bitcoin}{0.9}{0.5}
  \placesubfigure{eth_dp_10K_12_months.pdf}{fig:eth_dp_10K_12_months}{Egalitarianism of Ethereum}{0.9}{0.5}
  \placesubfigure{ltc_dp_10K_12_months.pdf}{fig:ltc_dp_10K_12_months}{Egalitarianism of Litecoin}{0.9}{0.5}
  \placesubfigure{xmr_dp_10K_12_months.pdf}{fig:xmr_dp_10K_12_months}{Egalitarianism of Monero}{0.9}{0.5}
  \placesubfigure{dcr_dp_10K_12_months.pdf}{fig:dcr_dp_10K_12_months}{Egalitarianism of \emph{proof-of-work} Decred}{0.9}{0.5}
...
\begin{figure}
  \placesubfigure{decred-stake.pdf}{fig:decred-stake}{Egalitarianism of \emph{proof-of-stake} Decred}{0.9}{0.5}
  \placesubfigure{pure-pos.pdf}{fig:pure-pos-stake}{Egalitarianism of \emph{proof-of-stake} Ouroboros}{0.9}{0.5}
...
the small\footnote{As of January $2019$, according to \url{https://cardanoexplorer.com/} in the
Cardano implementation of Ouroboros these fees are in the order of $\$0.01$.}
capital which is required to pay the transation fees to participate in
the staking.
...
\begin{table}
  ...
  \begin{tabular}{|c|c|r|}
    ...
    \hline
    Bitcoin &  Proof-of-work &  -0.03449029833964359 \\
    \hline
    Ethereum & Proof-of-work &  -0.0069261142964244515 \\
    \hline
    Litecoin & Proof-of-work &  -0.0002718220193051599 \\
    \hline
    Monero &   Proof-of-work &  -0.002206135001892895 \\
    \hline
      Decred & \begin{tabular}{c} Proof-of-work \\ Proof-of-stake \end{tabular} & \begin{tabular}{c} -0.41252464212652074 \\ -0.00034828009234172 \end{tabular}  \\
    \hline
    Ouroboros & Proof-of-stake & -0.00000029505435647 \\
    \hline
  \end{tabular}

...
Figures~\ref{fig:btc_dp_10K_12_months}, ~\ref{fig:eth_dp_10K_12_months}, ~\ref{fig:ltc_dp_10K_12_months}, and~\ref{fig:xmr_dp_10K_12_months} respectively.
...
\begin{figure}
  ...
  \placesubfigure{ideal.pdf}{fig:ideal}{The ideal egalitarian curve of an ideal cryptocurrency.}{0.75}{0.5}
  \caption{Egalitarian curves}
  \label{fig:egalitarian_curves}
\end{figure}

...
``egalitarian,'' where egalitarianism broadly refers 
%to the power of each coin to participate in the creation of new coins.
to the ability of the system to equalise participants' access to maintenance operations
and new coin creation.
While proof-of-work
...
\emph{egalitarianism}. 
%
Based on our definition, we measure the egalitarianism of
...
egalitarianism. 
We also measure the egalitarianism of a stake-based
protocol, Ouroboros, and a hybrid proof-of-stake/proof-of-work cryptocurrency, Decred.
We show that stake-based cryptocurrencies, under correctly selected parameters, can be perfectly egalitarian, perhaps contradicting folklore belief.
\end{abstract}

...
MAX_CAPITAL = 100000
DECRED_USD_PRICE = 100
TICKET_USD_PRICE = 6 * DECRED_USD_PRICE
DCR_COST_OF_TX_PER_BYTE = 0.000001
# Assumption: We solo stake
# POOL_STAKING_TX_SIZE = 539
SOLO_STAKING_TX_SIZE = 298
TICKET_USD_FEE = SOLO_STAKING_TX_SIZE * DCR_COST_OF_TX_PER_BYTE * DECRED_USD_PRICE
...
EXPECTED_GAINS_PERCENTAGE_PER_TICKET = \
    (TICKET_USD_PRICE * (1 + EXPECTED_RETURN_PERCENTAGE_PER_TICKET)
   - TICKET_USD_COST) / TICKET_USD_COST

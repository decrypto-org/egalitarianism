...
subsequently adopted in the resulting blockchain. \aggelos{added the following sentence and did
minor edits in the remaining paragraph}
...
equal rewards as a \emph{rich investor}. In this point of view egalitarianism would suggest
that despite the fact that  larger
investments do bear larger risk,   wealthy investors should not be rewarded
...
Until now, the term \emph{egalitarianism} has been left undefined \todo{some references to e.g. the bitcoin forum would
be appropriate here}, although
...
Decred \footnote{See: \url{https://www.decred.org/} [Online: December 2018]}. 
We find that, in an open market,  pure proof-of-stake coins are perfectly
